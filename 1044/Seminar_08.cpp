...
istream& operator>>(istream& citire, Cozonac& c) {
	cout << "Tip cozonac:";
	citire >> c.tip;
	cout << "Nr ingrediente:";
...
void main() {
	...
	cout << endl << "Inainte de operatorul++" << endl;
	c5.afisareCozonac();
	c6.afisareCozonac();
	...
	float totalGrame = (float)c6;
	cout << endl << nrIngrediente;
	cout << endl << totalGrame;
